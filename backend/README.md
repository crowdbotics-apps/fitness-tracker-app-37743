...
## Project Structure
    ...
    ├── sport_app_template_37743  # Django project configurations
...
1. Clone this repo and `cd sport_app_template_37743`
...
2. Clone this repo and `cd sport_app_template_37743`
